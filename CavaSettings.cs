...
namespace Honorbuddy.Quest_Behaviors.Cava.CavaSettings
{
    [CustomBehaviorFileName(@"Cava\CavaSettings")]
    class CavaSettings : CustomForcedBehavior
    {
        ...
        public CavaSettings(Dictionary<string, string> args)
            : base(args)
        {
            try
            {
        ...
        public override string SubversionId { get { return ("$Id: CavaSettings.cs 501 2013-05-10 16:29:10Z chinajade $"); } }
