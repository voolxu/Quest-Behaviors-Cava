...
namespace Honorbuddy.Quest_Behaviors.Cava.VehicleCanSelfHeal
{
    ...
    /// </summary>
    [CustomBehaviorFileName(@"Cava\VehicleCanSelfHeal")]
    public class VehicleCanSelfHeal : CustomForcedBehavior
    {
        public VehicleCanSelfHeal(Dictionary<string, string> args)
            : base(args)
        {
            try
            {
        ...
        public override string SubversionId { get { return ("$Id: VehicleCanSelfHeal.cs 249 2012-09-19 01:31:37Z natfoth $"); } }
        ...
        private PlayerQuest Quest
        {
            get
            {
                return _quest ?? (_quest = Me.QuestLog.GetQuestById((uint)QuestId));
            }
        }
