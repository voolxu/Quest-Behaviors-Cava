...
namespace Honorbuddy.Quest_Behaviors.Cava.UseTransport2
{
    [CustomBehaviorFileName(@"Cava\UseTransport2")]
    public class UseTransport2 : CustomForcedBehavior
    {
        ...
        public override string SubversionId { get { return ("$Id: UseTransport2.cs 369 2013-03-18 09:05:58Z chinajade $"); } }
        ...
        protected override Composite CreateBehavior()
        {
            return _root ?? (_root =
                new PrioritySelector(
                    ...
                    new Decorator(
                        ret => TransportLocation != WoWPoint.Empty && TransportLocation.Distance(EndLocation) < 3 && _usedTransport,
                        new PrioritySelector(
                            new Decorator(
