...
namespace Honorbuddy.Quest_Behaviors.Cava.TheBurlapGrind
{
    [CustomBehaviorFileName(@"Cava\30747-KunLai-TheBurlapGrind")]
        ...
        public List<WoWUnit> Monkies
        {
            get
            {
                ...
                return (from u in ObjectManager.GetObjectsOfType<WoWUnit>()
                    where MobIds.Contains(u.Entry) && !u.IsDead && u.InLineOfSight
                    let loc = u.Location
