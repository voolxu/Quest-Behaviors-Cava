...
namespace Honorbuddy.Quest_Behaviors.Cava.FlyTo
{
	[CustomBehaviorFileName(@"Cava\FlyTo")]
	class FlyTo : QuestBehaviorBase
	{
		...
		public override string SubversionId { get { return ("$Id: FlyTo.cs 1581 2014-06-27 02:34:30Z Mainhaxor $"); } }
