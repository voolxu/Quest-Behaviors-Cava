...
namespace Honorbuddy.Quest_Behaviors.Cava.SalhetTheTactician
{
    [CustomBehaviorFileName(@"Cava\28277-Uldum-SalhetTheTactician")]
    public class Lions : CustomForcedBehavior
    {
        ...
        {
            get { return ObjectManager.GetObjectsOfType<WoWUnit>().Where(ret => (ret.Entry == 48237)).OrderBy(ret => ret.Distance).ToList(); }
        }
