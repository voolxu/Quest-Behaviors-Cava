...
namespace Honorbuddy.Quest_Behaviors.Cava.InteractWith1324
{
	[CustomBehaviorFileName(@"Cava\InteractWith1324")]
	public class InteractWith : QuestBehaviorBase
	{
		...
		{
			get { return ("$Id: InteractWith.cs 1324 2014-03-12 22:16:09Z highvoltz $"); }
		}

		public override string SubversionRevision
		{
			get { return ("$Revision: 1324 $"); }
		}
