...
namespace Honorbuddy.Quest_Behaviors.Cava.CastSpellOn
{
	[CustomBehaviorFileName(@"Cava\CastSpellOn")]
	...
	public class CastSpellOn : CustomForcedBehavior
	{
		...
		private List<Tuple<string, string>> BuildReplacementArguments()
		{
			...
			QuestBehaviorBase.BuildReplacementArg(replacementArgs, SpellIds.FirstOrDefault(), "InteractByCastingSpellId", 0);
			QuestBehaviorBase.BuildReplacementArgs_Ids(replacementArgs, "MobId", MobIds, true);

			if (MobHpPercentLeft < 100.0)
			{
				QuestBehaviorBase.BuildReplacementArg(replacementArgs, MobStateType.Alive, "MobState", MobStateType.BelowHp);
				QuestBehaviorBase.BuildReplacementArg(replacementArgs, MobHpPercentLeft, "MobHpPercentLeft", 100.0);
			}
			...
			QuestBehaviorBase.BuildReplacementArg(replacementArgs, MinRange, "MinRange", 0.0);
		...
		public override string SubversionId { get { return ("$Id: CastSpellOn.cs 1581 2014-06-27 02:34:30Z Mainhaxor $"); } }
