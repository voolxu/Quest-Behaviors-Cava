...
namespace Honorbuddy.Quest_Behaviors.SpecificQuests.Cava.MurkethAndShaadraz
{
    [CustomBehaviorFileName(@"Cava\10129-10146-Hellfire-MurkethAndShaadraz")]
    public class MurkethAndShaadraz : CustomForcedBehavior
    {
        ~MurkethAndShaadraz()
        {
            Dispose(false);
       ...
       public WoWUnit Flyer
        ...
        public WoWItem Bomb
        {
            get { return Me.BagItems.FirstOrDefault(r => r.Entry == 28038); }
        }
