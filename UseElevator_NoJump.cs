...
namespace Honorbuddy.Quest_Behaviors.UseElevator_NoJump
{
    [CustomBehaviorFileName(@"Cava\UseElevator_NoJump")]
    public class UseElevator_NoJump : CustomForcedBehavior
    {
        /// <summary>
        ...
        /// </summary>
        ///
        public UseElevator_NoJump(Dictionary<string, string> args)
            : base(args)
        {
            try
            {
        ...
        public override string SubversionId { get { return ("$Id: UseElevator_NoJump.cs 501 2013-05-10 16:29:10Z chinajade $"); } }
