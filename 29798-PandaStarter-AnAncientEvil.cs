...
namespace Honorbuddy.Quest_Behaviors.Cava.AnAncientEvil
{
    [CustomBehaviorFileName(@"Cava\29798-PandaStarter-AnAncientEvil")]
    public class AnAncientEvil : CustomForcedBehavior
    {
        ...
        public Composite DoneYet
        {
            get
            {
                return new Decorator(ret => Me.IsQuestComplete(QuestId) || !Me.IsAlive,
                    new Action(delegate
                    {
